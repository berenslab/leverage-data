...
from .dino_vision_transformer import BlockChunk
...
class SSLMetaArch(nn.Module):
    def __init__(self, cfg):
        super().__init__()
        self.cfg = cfg
        self.fp16_scaler = None# ShardedGradScaler() if cfg.compute_precision.grad_scaler else None
        ...
        if cfg.student.pretrained_weights:
            ...
            load_dinov2_weights(student_backbone, cfg.student.pretrained_weights)
            # student_backbone.load_state_dict(chkpt["model"], strict=True)
    ...
    def update_teacher(self, m):
        with torch.no_grad():
            for k in self.student.keys():
                for param_s, param_t in zip(self.student[k].parameters(), self.teacher[k].parameters()):
