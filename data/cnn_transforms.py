...
def get_transforms(img_size: int = 512, more_augment: bool = None):
    ...
    """
    assert more_augment in [True, False], "more_augment argument must be True or False. It is currently set to: {}".format(more_augment)
    
    if more_augment != True:
        transformations = [
            transforms.ToTensor(),
    ...
    aug_args: Dict[str, Any] = {
        "random_crop": {"scale": [0.85, 1], "p": 1.0},
        "flip": {"p": 0.5},
        "color_jitter": {
            "p": 0.5,
            "brightness": 0.2,
...
# def extended_transforms(img_size):
#     aug_args: Dict[str, Any] = {
#         "random_crop": {"scale": [0.85, 1], "p": 1.0},
#         "flip": {"p": 0.5},
#         "color_jitter": {
